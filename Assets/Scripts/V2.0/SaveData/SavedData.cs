...
namespace SaveData
{
    ...
    public sealed class SavedData
    {
        public GameObject flyerObject;
                ...
                // todo сохранять AddressableReference и позицию (написать метод преобразования Vector3 в float и обратно)
              // При загрузке по ссылке инстансить объекты и раставлять на позиции
            // todo сохранять все данные хода - чей ход, счёт и т.д.
          // и что, это всё в ручную прописывать значит __--__
